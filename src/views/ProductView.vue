<template>
  <main-master-page>
    <template v-if="itemsStore.currentItem">
      <div class="product">
        <div class="container">
                ...
                <div class="product__action">
                  <div class="product__action-left">
                    <div class="product__action-count">
                      <button
                        @click="onCount('decrease')"
                        class="product__action-decrease"
                      ></button>
                      <div type="number" min="1">{{ countToBuy }}</div>
                      <button
                        @click="onCount('increase')"
                        class="product__action-increase"
                      ></button>
                    </div>
...
onMounted(() => {
  itemsStore.getItemById(route.params.id)
})
